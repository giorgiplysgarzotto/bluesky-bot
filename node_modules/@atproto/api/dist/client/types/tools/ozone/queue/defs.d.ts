...
export declare function isQueueView<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.queue.defs", "queueView">;
...
export declare function isQueueStats<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.queue.defs", "queueStats">;
...
export declare function isAssignmentView<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.queue.defs", "assignmentView">;

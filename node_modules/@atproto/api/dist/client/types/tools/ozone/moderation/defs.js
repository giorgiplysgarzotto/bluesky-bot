...
export function isSubjectView(v) {
...
export function isAccountStats(v) {
...
export function isRecordsStats(v) {
...
export function isAccountStrike(v) {
...
export function isAgeAssuranceEvent(v) {
...
export function validateAgeAssurancePurgeEvent(v) {
    return validate(v, id, hashAgeAssurancePurgeEvent);
}
...
export function isModEventMuteReporter(v) {
...
export function isReporterStats(v) {
...
export function isModTool(v) {
    return is$typed(v, id, hashModTool);
}
export function validateModTool(v) {
...
export function isScheduledActionView(v) {

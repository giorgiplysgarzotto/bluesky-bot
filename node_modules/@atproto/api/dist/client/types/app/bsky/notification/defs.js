...
export function isRecordDeleted(v) {
...
export function isChatPreference(v) {
...
export function isFilterablePreference(v) {
...
export function isActivitySubscription(v) {

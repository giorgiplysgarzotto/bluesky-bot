...
export function isTrendingTopic(v) {
...
export function isSkeletonTrend(v) {
...
export function isThreadItemNotFound(v) {
...
export function isThreadItemBlocked(v) {
...
export function isAgeAssuranceState(v) {

...
export function isVerificationState(v) {
...
export function isVerificationView(v) {
...
export function validateSavedFeed(v) {
...
export function isDeclaredAgePref(v) {
...
export function validateMutedWord(v) {
...
export function isLiveEventPreferences(v) {
...
export function isStatusView(v) {
    return is$typed(v, id, hashStatusView);
}
export function validateStatusView(v) {

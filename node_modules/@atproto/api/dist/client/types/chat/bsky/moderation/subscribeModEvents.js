...
export function isEventGroupChatJoinRequestApproved(v) {
    return is$typed(v, id, hashEventGroupChatJoinRequestApproved);
}
export function validateEventGroupChatJoinRequestApproved(v) {
